import { GET_COMMENTS_ERROR, GET_COMMENTS_REQUEST, GET_COMMENTS_SUCCESS, GET_POSTS_BY_PAGE, GET_POSTS_ERROR, GET_POSTS_REQUEST, GET_POSTS_SUCCESS, SET_ACTIVE_POST, SET_FILTER } from "../actions/posts-page.actions";
import { CommentModel, PostModel } from "../core-module/models/posts-models";

interface PostPageStateModel {
    posts: PostModel[];
